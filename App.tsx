...
import { Terminal, RefreshCw, Trophy, ArrowRight, Copy, Check, FileCode, Zap, Clock, AlertTriangle, User, ShieldAlert, LogIn, Star, Edit2, X } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] bg-[#050505] flex flex-col font-sans text-zinc-300">
        ...
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            {status === AppStatus.QUIZ_READY && (
                <div className={`
                    flex items-center space-x-2 px-4 py-1.5 border-2 rounded-sm font-mono font-bold text-lg tracking-widest hidden md:flex
                    ${isOvertime 
      ...
      <main className="flex-grow container max-w-6xl mx-auto px-4 py-8">
        ...
        {/* Auth Warning / Recovery Banner */}
        {user && showRecoveryWarning && status === AppStatus.IDLE && (
